...
# check recall score for logistic regression
# Case-LR-1


y_pred, y_pred_prob = get_predictions(LogisticRegression(C = 0.01, penalty = 'l2',solver='lbfgs')
...
# train logistic regression with undersamples data
# Case-LR-2
...
y_und_pred, y_und_pred_prob = get_predictions(LogisticRegression(C = 0.01, penalty = 'l2',solver='lbfgs'), X_und_train, y_und_train, X_und_test)
